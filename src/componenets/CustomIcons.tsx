        ...
        <SvgIcon>
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g id="SVGRepo_iconCarrier">
                    ...
                    <path d="M12 6V14" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"
                          stroke-linejoin="round"></path>
                    <path d="M15 11L12 14L9 11" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"
                          stroke-linejoin="round"></path>
                </g>
            </svg>
        </SvgIcon>
...
export function TikTok(){
    return(
        <SvgIcon>
            <svg width="256px" height="256px" viewBox="62.370000000000005 70.49 675.3000000000001 675.3000000000001"
